                ...
                <div class="card border-0 rounded shadow">
                    <div class="card-body">
                        ...
                        <form @submit.prevent="store">
                            ...
                            <div class="form-group">
                                <label for="checkin" class="font-weight-bold">Checkin</label>
                            ...
                            <div class="form-group">
                                <label for="checkout" class="font-weight-bold">Checkout</label>
...
export default {
    ...
    setup() {
        ...
        function store() {
            ...
            axios.post('http://localhost:8000/api/Reservasi', {
                tipe: tipe,
